...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    const secondProductDetails = productDetails()[1].details.productId.substr(-3);
    assert.strictEqual( firstProductDetails, '123');
    assert.strictEqual( secondProductDetails, '123');
  });
});
