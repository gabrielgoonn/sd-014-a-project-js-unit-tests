...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    // assert.fail();
    // const circulo = circle ({ radius: 1, area: 3.14, circumference: 6.28 })
    ...
    // Pesquisa sobre deepStrictEqual realizada no site https://www.w3schools.com/nodejs/met_assert_deepstrictequal.asp
  });
});
