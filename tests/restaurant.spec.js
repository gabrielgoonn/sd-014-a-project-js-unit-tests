...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    objetoRetornado.order('coxinha');
    assert.deepStrictEqual(objetoRetornado.consumption.some((element) => element === 'coxinha'), true);
    ...
    const somaDosPreçosPedidos = 23.76;
    assert.strictEqual(meuRestaurante.pay(), somaDosPreçosPedidos);
