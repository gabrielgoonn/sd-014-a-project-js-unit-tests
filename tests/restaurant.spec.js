...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), undefined);
    ...
    // --------------------------------------------------------------------------------------
    const objeto = createMenu({ food: { coxinha: 3.9, sopa: 9.9 }, drink: { agua: 3.9, cerveja: 6.9 } });
    objeto.order('coxinha');
    objeto.order('agua');
    objeto.order('coxinha');
    assert.deepStrictEqual(objeto.consumption, ["coxinha", "agua", "coxinha"]);  
    ...
    // --------------------------------------------------------------------------------------
    assert.deepStrictEqual(objeto.pay(), 13);  
