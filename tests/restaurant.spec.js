...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const objetoRetornado3 = createMenu({food: 'coxinha', drink: 'suco'});
    ...
    const objetoRetornado4 = createMenu({food: {'coxinha': 3.90, 'sashimi': 19.90}, drink: {'agua': 3.90, 'sopa': 9.90}});
    ...
    const objetoRetornado5 = createMenu({ food: {'coxinha': 3.90, 'sashimi': 19.90}, drink: {'agua': 3.90, 'sopa': 9.90}});
