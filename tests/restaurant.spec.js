...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(['coxinha', 'agua', 'sopa', 'sashimi'], objetoRetornado.consumption);
    // ```
    ...
    // ```
    assert.deepStrictEqual(['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'agua', 'coxinha'], objetoRetornado.consumption);
    ...
    // ```
    assert.strictEqual(meuRestaurante.pay(), 11.70);
