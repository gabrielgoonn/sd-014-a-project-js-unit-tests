...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    assert.deepStrictEqual(createMenu('teste').fetchMenu(), 'teste')
    ...
    // ```
    assert.deepStrictEqual(createMenu('teste').consumption, [])
    ...
    // ```
    const teste8 = createMenu({food: {'coxinha': 3.90, 'sanduiche': 9.90}, drinks: {'agua': 3.90, 'cerveja': 6.90}});
