...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado(TESTES 1 A 5)', () => {
    ...
    assert.deepStrictEqual(createMenu({}).fetchMenu(), objetoRetornado.fetchMenu())
    ...
    // --------------------------------------------------------------------------------------
    it('Verifica se a função `createMenu` tem o comportamento esperado(TESTE 6)', () => {
    ...
    it('Verifica se a função `createMenu` tem o comportamento esperado(TESTE 7)', () => {
    ...
    it('Verifica se a função `createMenu` tem o comportamento esperado(TESTE 8)', () => {
    ...
    assert.deepStrictEqual(objetoRetornado.order('coxinha'), undefined )
    assert.deepStrictEqual(objetoRetornado.pay(), ((3.9 + 3.9 + 3.9+ 3.9 )*1.10)
