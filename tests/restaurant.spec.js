...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const objetoRetornado2 = createMenu({ cliente: {}});
    assert.deepStrictEqual(objetoRetornado2.fetchMenu(),{ cliente: {}});
    ...
    const objetoRetornado6 = createMenu({ food: {'coxinha': 4.5, 'sanduiche': 6.99}, drink: {'agua': 1.99 , 'cerveja': 3.99} });
    objetoRetornado6.order('coxinha');
    objetoRetornado6.order('agua');
    objetoRetornado6.order('coxinha');
    assert.deepStrictEqual(objetoRetornado6.pay(),10.99*1.1);
