...
describe('9 - Implemente os casos de teste para a função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    assert.deepStrictEqual(getCharacter('Arya'), expectedObj);
    ...
    assert.deepStrictEqual(getCharacter('Brienne'), expectedObj2);
    ...
    assert.deepStrictEqual(getCharacter('Melissandre'), expectedObj3);
