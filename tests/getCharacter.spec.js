...
describe('9 - Implemente os casos de teste para a função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    assert.deepStrictEqual(getCharacter('Arya'),{name: 'Arya Stark',class: 'Rogue',phrases: [ 'Not today', 'A girl has no name.' ]}); // code review no deep.
    ...
    assert.strictEqual(opcao1.toLowerCase() === opcao2.toLowerCase() === opcao3.toLowerCase(),false); // code review pq false e não true
