...
it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
  ...
  assert.deepStrictEqual(getCharacter('Arya'), { name: 'Arya Stark', class: 'Rogue', phrases: ['Not today', 'A girl has no name.'],}); // Pega o characters, da importacao
  // Teste se a função retorna o objeto correto para o parâmetro 'Brienne',
  assert.deepStrictEqual(getCharacter('Brienne'), { name: 'Brienne Tarth', class: 'Knight', phrases: ['Im No Lady, Your Grace.', 'I, Brienne Of Tarth, Sentence You To Die.'],}); // Pega o characters, da importacao
  // Teste se a função retorna o objeto correto para o parâmetro 'Melissandre',
  assert.deepStrictEqual(getCharacter('Melissandre'), {name: 'Melissandre', class: 'Necromancer', phrases: ['Death By Fire Is The Purest Death.', 'For The Night Is Dark And Full Of Terrors.'],}); // Pega o characters, da importacao
